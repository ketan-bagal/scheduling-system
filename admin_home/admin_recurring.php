...
<script>
	function clearAreas() {
var div2 = document.getElementById("cohort");
		div2.innerHTML='';
		...
		{
		var div = document.getElementById("cohort");
		var input7 = document.createElement("input");
		input7.type="text";
		input7.id = "Cohort";
		input7.name = "cohort";
		input7.setAttribute("placeholder","cohort name");
		var label7 = document.createElement("label");
		label7.innerHTML = "Cohort:";
...
<div id="container">
<div class="form">
<form id="container" action="./admin_recurring_view.php">
<fieldset>
...
Purpose of booking:
<label><input type="radio" name="usertype" value="0" onclick="askAreas()" checked>Class</label>
<label><input type="radio" name="usertype" value="1" onclick="clearAreas()">Other</label>
<div id="cohort">
<label>Cohort:</label>
<input type="text" name="cohort" id="Cohort" value="" placeholder="cohort name" /><br />
</div>
<?php
...
$("#container").on('submit', function () 
		{	
			...
			if (enddate == null || enddate == "") 
			{
				d += 500;
				alertify.set({ delay: d });
				alertify.log("enddate is required");
				flag=false;
			}
			...
			if (enddate == 0) 
			{
				d += 500;
				alertify.set({ delay: d });
				alertify.log("enddate cannot be Sunday");
				flag=false;
			}
			...
			if (course == null || course == "") 
			{
				d += 500;
				alertify.set({ delay: d });
				alertify.log("cohort/reason is required");
				flag=false;
			}
