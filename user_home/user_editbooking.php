...
include '../php_script/connectDB.php';
	...
	if($runquery=mysqli_query($conn,$result))
			...
			header('location: ./user_editbooking.php');
			exit();
			}
			if(!$runquery)
			{
...
function confirmAction (id) {
	...
	alertify.confirm('Are you sure you wish to confirm '+did+'?', function(e) {
        if (e) {
            ...
            window.location.href = "./user_editbooking.php?confirmingid=" + did; 
            }
...
function deleteAction (id) {
	...
	alertify.confirm('Are you sure you wish to delete '+did+'?', function(e) {
        if (e) {
            ...
            window.location.href = "./user_editbooking.php?deletingid=" + did; 
            }
